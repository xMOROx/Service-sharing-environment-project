...
helm upgrade --install $HELM_KUBE_PROMETHEUS_STACK_DEPLOYMENT_NAME prometheus-community/kube-prometheus-stack -n $KUBE_PROMETHEUS_STACK_NAMESPACE --values $KUBE_PROMETHEUS_STACK_VALUES_PATH
